...
function _injectMoodOfDay() {
    ...
    banner.innerHTML = `
        ...
        <button class="mood-today__close"  title="Fermer" aria-label="Fermer" style="color: white; background: rgba(255, 0, 0, 0.31); width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">✕</button>
    `;
